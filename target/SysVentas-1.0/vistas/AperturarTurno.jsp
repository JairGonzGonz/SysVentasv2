...
<html>
    ...
    <body>
        ...
        <div class="container login-container">
            <h2 class="text-center">Apertura de Turno</h2>
            <form action="tuServletDeGestion" method="POST">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="numAbono" name="numAbono" class="form-control" placeholder="1.00" step="0.50" min="0" max="9999999.00" style="text-align:right;" />
                        </div>
                        <div class="form-group">
                ...
                <hr>
                <button type="submit" class="btn btn-primary btn-block">Aperturar</button>
            </form>
        </div>
